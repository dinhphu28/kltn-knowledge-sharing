...
alter table app_fd_article add fulltext(c_title, c_description, c_content);
show index from app_fd_article;
...
create table app_fd_articles_for_home (
    id varchar(255) not null primary key,
    c_article_id varchar(255) not null,
    dateCreated datetime,
    dateModified datetime,
    ...
    constraint 55A5B27F80824BB780FDD02275A4B3D8
                            foreign key (c_article_id) references app_fd_article(id)
);

create table app_fd_sys_notification (
    id varchar(255) not null primary key,
    dateCreated datetime,
    createdBy varchar(255),
    createdByName varchar(255),
...
create table app_fd_user_notification (
    id varchar(255) not null primary key,
    dateCreated datetime,
    createdBy varchar(255),
    createdByName varchar(255),
    ...
    constraint FK927C3A61E3F24309BBAD4DB7558A5742
                            foreign key (c_for_user) references dir_user(id)
);
